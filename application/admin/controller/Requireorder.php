                ...
                if($v['status'] == 'init'){
                    ...
                    if($v['is_appoint_sup'] == 1){
                        if(!empty($v['appoint_sup_name'])){
                            ...
                            //选择供应商
                            $inquiry = '<a class="select_sell" href="javascript:void(0);" onclick="bomb_box1(event,\''.$v['pr_code'].'\',\''.$v['item_code'].'\',\''.$v['id'].'\',\''.$v['item_name'].'\');" data-url="'.url('requireorder/selectSup', array(
                                    'pr_code' => $v['pr_code'],
