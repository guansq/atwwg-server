...
define(['jquery', 'admin.plugs'], function(){
  ...
  this.$body.on('click', '[data-update]', function(){
    ...
    var optmsg = $(this).attr('data-optmsg') || $(this).html() ||'操作';
    $.msg.confirm('确定要'+optmsg+'这些数据吗？', function(){
      $.form.load(action, {field:field, value:value, id:id}, method);
    });
  });
  ...
  this.$body.on('click', '[data-phone-view]', function(){
    ...
    var $container = $('<div class="mobile-preview pull-left"><div class="mobile-header">公众号</div><div class="mobile-body"><iframe id="phone-preview" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>')
        .appendTo('body');
  ...
  /*! Mini Tips 显示*/
  $('body')
      .on('mouseenter mouseleave', '.framework-sidebar-mini .sidebar-trans .nav-item,.framework-sidebar-mini .sidebar-title', function(e){
        $(this).tooltip({
