...
class Supporter extends BaseLogic{
    ...
    public function getOneSupInfo($sup_id){
        ...
        $supinfo = supModel::alias('a')
            ...
            a.mobile,a.fax,a.email,a.address,a.status,a.purch_code,a.purch_name,a.purch_type,a.check_type,a.check_rate,a.pay_way,a.pay_way_change,a.pay_way_status,a.create_at,t.arv_rate,t.pp_rate')
