...
class Order extends BaseLogic{
    ...
    function getOrderListInfo($sup_code=''){
        $list = Po::alias('a')->field('b.po_code,a.order_code,a.status,b.arv_goods_num,b.pro_goods_num,a.contract_time')->join('po_item b','a.order_code= b.po_code')->where(['sup_code'=>$sup_code])->order('create_at desc')->select();
